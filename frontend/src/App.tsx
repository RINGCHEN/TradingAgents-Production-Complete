...
import ProfessionalPortfolioPageComponent from './pages/ProfessionalPortfolioPage';
...
const PortfolioPage = withPageErrorBoundary(ProfessionalPortfolioPageComponent);
